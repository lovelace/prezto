...
02. Clone the repository (links modified to point to this repo):

    ```console
    git clone --recursive https://github.com/lovelace/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
    ```
    ...
    <details>
      ...
      - Clone the repository:
        ...
        ```console
        git clone --recursive https://github.com/lovelace/prezto.git "${ZDOTDIR:-${XDG_CONFIG_HOME:-$HOME/.config}/zsh}/.zprezto"
        ```
